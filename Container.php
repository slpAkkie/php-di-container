...
class Container implements ContainerContract
{
     ...
     * TODO: Бросать исключение, если конкретный класс не реализует укзанный интерфейс или абстрактный класс.
     * ? Нужна ли проверка на то, что привязка уже существует?
     *
